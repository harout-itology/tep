...
$db= new Database();
    $db->connect();
$mtaquery= 'SELECT mtaname, count( mtaname ) as cnt FROM db_st_towerco_new GROUP BY mtaname';
$btaquery= 'select mtaname,btaname, count(btaname) as cnt from db_st_towerco_new group by btaname order by mtaname asc';
$towerownersquery='select distinct TowerOwner from db_st_towerco_new where TowerOwner!=""';
